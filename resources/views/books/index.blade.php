          ...
          <div class="col-lg-4 mb-5">
            <div class="card h-100 shadow border-0 snow-background">
              ...
              <div class="card-body p-4">
                ...
                <a class="text-decoration-none link-dark stretched-link text-dark"
                  href="{{route('books.show',['book' =>$book->id ])}}">
                  <h5 class="card-title mb-3">{{$book->name}}</h5>
                </a>
                <p class="card-text mb-0 text-dark">Some quick example text to build on the card title and make up
              ...
              <div class="card-footer p-4 pt-0 bg-transparent border-top-0">
                <div class="d-flex align-items-end justify-content-between">
                  <div class="d-flex align-items-center">
                    ...
                    <div class="small">
                      <div class="fw-bold text-dark">Kelly Rowan</div>
                      <div class="text-dark">March 12, 2023 &middot; 6 min read</div>
                    </div>
                  </div>
                </div>
              </div>
