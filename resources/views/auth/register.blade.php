    ...
    <div class="container my-5">
      <div class="row justify-content-center">
        <div class="col-12 col-md-8">
          <form class="p-5 shadow rounded bg-dark " action="{{route('register')}}" method="POST">
            @method('POST')
            @csrf
            @if ($errors->any())
            ...
            @endif
            <div class="mb-3">
              <label for="name" class="form-label text-light">Nome utente</label>
            ...
            <a href="{{route('login')}}" class="btn btn-outline-light bg-gradient">Gia' iscritto?</a>
          </form>
        </div>
      </div>
    </div>
